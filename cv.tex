...
\begin{tightemize}
	...
	\item Standardize delivery infrastructure by developing and maintaining over 20 reusable Terraform modules adopted across the Azure Platform Team to ensure consistent and compliant configurations.
	\item Drive deployment framework evolution by refactoring pipelines and Terraform module logic, reducing deployment failures and enabling more reliable infrastructure delivery.
	\item Reduces the number of internal demands by re-engineering the delivery strategy of frequently changing resources.
	\item Train and mentor 10 team members on Terraform/GitHub deployment framework, enabling independent management of infrastructure changes.
\end{tightemize}
\sectionsep
