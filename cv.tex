...
{\runsubsectionlower{Cloud:}\skillsdescript{Microsoft Azure}} & {\runsubsectionlower{Programming:}\skillsdescript{PHP $\cdot$ C\# $\cdot$ Java}} \\[12pt]
{\runsubsectionlower{IaC:}\skillsdescript{Terraform $\cdot$ HCP}} & {\runsubsectionlower{UI:}\skillsdescript{Joomla $\cdot$ WordPress $\cdot$ Angular $\cdot$ React $\cdot$ Asp.Net}} \\[12pt]
{\runsubsectionlower{CI/CD:}\skillsdescript{Azure DevOps $\cdot$ GitHub Actions}} & {\runsubsectionlower{Containers:}\skillsdescript{Docker $\cdot$ K8S}} \\[12pt]
{\runsubsectionlower{VCS:}\skillsdescript{GitHub $\cdot$ Azure Repos $\cdot$ Bitbucket}} & {\runsubsectionlower{Templating:}\skillsdescript{Jinja2 $\cdot$ Nunjucks $\cdot$ FreeMarker}} \\[12pt]
{\runsubsectionlower{Scripting:}\skillsdescript{Bash $\cdot$ PowerShell $\cdot$ Python}} & {\runsubsectionlower{CSS:}\skillsdescript{sass $\cdot$ scss $\cdot$ less}} \\[12pt]
{\runsubsectionlower{CaC:}\skillsdescript{Ansible (roles \& playbooks)}} & {\runsubsectionlower{Agile:}\skillsdescript{SAFe $\cdot$ Scrum $\cdot$ Kanban}} \\[12pt]
{\runsubsectionlower{Artifacts:}\skillsdescript{Artifactory $\cdot$ ACR $\cdot$ Azure Artifacts}} & {\runsubsectionlower{Collaboration:}\skillsdescript{Jira $\cdot$ Confluence $\cdot$ Teams $\cdot$ Slack}}
\end{tabular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     Education
