...
\begin{tightemize}
	...
	\item Hands-on experience with Infrastructure as Code (IaC) using Terraform
	\item Ability to orchestrate deployments of complex cloud environments
	\item Expert in versioning practices and artifact management to ensure consistency and repeatability
	\item Strong knowledge of Azure Landing Zone (architecture, networking, access control, security, monitoring)
	\item Proficiency in scripting languages such as Python, Bash, or PowerShell for automation tasks
	\item Experienced full-stack developer with expertise in Joomla, WordPress, React, Angular, and .NET Core
	\item Experience working in Agile development environments (Kanban / Scrum / SAFe)
...
\runsubsection{Desjardins}\descript{| Azure Platform / DevOps Engineer}\hfill \location{Montreal, QC | 2022 – Present}
\begin{tightemize}
...
\end{tightemize}
\skillsdescript{Skills:}\skills{ Azure Cloud, Terraform, Terraform Cloud Platform, Azure DevOps, GitHub Actions, Bash, PowerShell, Artifactory, Hashicorp Vaults, Az CLI, JFrog CLI, SAFe, Jira}
\sectionsep
...
\begin{tightemize}
	\item Developed custom and self-managed websites using Joomla frontend/backend
...
\raggedright
\begin{tabular}{ l l }
	\descript{Microsoft Certified} \\
	{\location{• Azure Administrator Associate - 2023}} \\
	{\location{• DevOps Engineer Expert - 2023}} \\
	\descript{GitHub Certified} \\
	{\location{GitHub Fundamentals - 2025, GitHub Actions}} \\
	{\location{GitHub Actions - 2025}}
\end{tabular}
\sectionsep
