...
\raggedright
\begin{tabular}{ l l }
	\descript{Cloud} & {\location{Azure}} \\
	\descript{IaC} & {\location{Terraform Hashicorp Cloud Platform}} \\
	\descript{CI/CD} & {\location{Azure DevOps, GitHub Actions}} \\
	\descript{Scripting} & {\location{Bash, PowerShell}} \\
	\descript{Version Control} & {\location{GitHub, Azure Repos, Bitbucket}} \\
	\descript{Configuration Management} & {\location{Ansible}} \\
	\descript{Artifact Management} & {\location{Artifactory, Azure Artifacts, Azure Container Registry}} \\
	\descript{Containers} & {\location{Docker, Kubernetes (AKS)}} \\
	\descript{Programming language} & {\location{C\#, PHP}} \\
	\descript{UI Frameworks} & {\location{WebComponents, Angular, React, Asp.NET Core}} \\
	\descript{Javascript Tools} & {\location{Webpack, Gulp, npm-scripts}} \\
	\descript{Templating engine} & {\location{Jinja2, Nunjucks}} \\
	\descript{CSS preprocessor} & {\location{SASS, SCSS, LESS}} \\
	\descript{Agile methodologies} & {\location{SAFe, Scrum, Kanban}} \\
