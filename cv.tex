...
\end{tightemize}
\sectionsep
\projets{Project(s):}{Cloud Transformation Program, Connectivity Landing Zone (Hub-Spoke), Business Landing Zone}
\sectionsep
...
\end{tightemize}
\sectionsep
\projets{Project(s):}{In-House Keycloak-based Single Sign-On solution, Connex}
\sectionsep
