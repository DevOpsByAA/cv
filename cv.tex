...
\begin{tightemize}
	\item Accelerated deployment of the in-house Keycloak-based SSO solution by automating build, promotion, and release pipelines in Azure DevOps for AKS environments.
