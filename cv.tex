...
\begin{tightemize}
	\item Accelerated the deployment of 4 products across SaaS and on-premise environments by designing and implementing a delivery cycle as code in Azure DevOps.
...
\raggedright
\runsubsection{GitHub Certified}\descript{| GitHub Actions}\hfill \location{2025}\\
\sectionsep
\runsubsection{GitHub Certified}\descript{| GitHub Fundamentals}\hfill \location{2025}\\
\sectionsep
\runsubsection{Microsoft Certified}\descript{| Azure Administrator Associate}\hfill \location{2023}\\
\sectionsep
\runsubsection{Microsoft Certified}\descript{| Azure DevOps Engineer Expert}\hfill \location{2023}\\
\sectionsep
