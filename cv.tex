...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Alexander Acevedo}{DevOps Engineer}{ | Montreal, QC | (438) 993-6121 | alex.devops.email@gmail.com |}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%	    Summary (optional)
%
...
\begin{tightemize}
	\item 8+ years of software development experience, including 4+ years specializing in DevOps/SRE
