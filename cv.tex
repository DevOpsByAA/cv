...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Alexander Acevedo}{DevOps Engineer}{Montreal, QC | (438) 993-6121 | alex.devops.email@gmail.com | \href{https://www.linkedin.com/in/alex-acevedo-devops}{LinkedIn}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%	    Summary (optional)
%
...
\begin{tabular}{ l l }
    % First column                                  % Second column
		\skillitem{Cloud:}{ Azure} & \skillitem{Artifacts:}{ Artifactory, Az Artifacts, Az Container Registry} \\
		\skillitem{IaC:}{ Terraform $\textbullet$ Hashicorp Cloud Platform} & \skillitem{Programming:}{ C\# $\textbullet$ PHP} \\
		\skillitem{CI/CD:}{ Azure DevOps, GitHub Actions} & \skillitem{Containers:}{ Docker, Kubernetes (AKS)} \\
		\skillitem{VCS:}{GitHub, Azure Repos, Bitbucket} & \skillitem{UI Frameworks:}{WebComponents, Angular, React, Asp.NET} \\
		\skillitem{Scripting:}{ Bash, PowerShell, Python} & \skillitem{Templating engine:}{ Jinja2, Nunjucks} \\
		\skillitem{CaC:}{ Ansible} & \skillitem{Agile methodologies:}{ SAFe, Scrum, Kanban} \\
    % \skillsdescript{Cloud:} {\skillslist{Azure}} & \skillsdescript{Artifacts:} {\skillslist{Artifactory, Azure Artifacts, ACR}} \\
    % \skillsdescript{IaC:} {\skillslist{Terraform, HCP}} & \skillsdescript{Containers:} {\skillslist{Docker, Kubernetes \(AKS\)}} \\
    % \skillsdescript{CI/CD:} {\skillslist{Azure DevOps, GitHub Actions}} & \skillsdescript{Programming:} {\skillslist{C\#, PHP}} \\
    % \skillsdescript{Scripting:} {\skillslist{Bash, PowerShell, Python}} & \skillsdescript{UI Frameworks:} {\skillslist{WebComponents, Angular, React, Asp.NET Core}} \\
    % \skillsdescript{Version Control:} {\skillslist{GitHub, Azure Repos, Bitbucket}} & \skillsdescript{Javascript Tools:} {\skillslist{Webpack, Gulp, npm-scripts}} \\
    % \skillsdescript{CaC:} {\skillslist{Ansible}} & \skillsdescript{Templating engine:} {\skillslist{Jinja2, Nunjucks}} \\
    % \skillsdescript{CSS preprocessor:} {\skillslist{SASS, SCSS, LESS}} & \skillsdescript{Agile methodologies:} {\skillslist{SAFe, Scrum, Kanban}} \\
\end{tabular}
\sectionsep
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
