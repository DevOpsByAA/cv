...
% First column - 7 items
\runsubsectionlower{Cloud:}\descript{Microsoft Azure} \\
\sectionsep
\runsubsectionlower{IaC:}\descript{Terraform $\cdot$ HCP} \\
\sectionsep
\runsubsectionlower{CI/CD:}\descript{Azure DevOps $\cdot$ GitHub Actions} \\
\sectionsep
\runsubsectionlower{VCS:}\descript{GitHub $\cdot$ Azure Repos $\cdot$ Bitbucket} \\
\sectionsep
\runsubsectionlower{Scripting:}\descript{Bash $\cdot$ PowerShell $\cdot$ Python} \\
\sectionsep
\runsubsectionlower{CaC:}\descript{Ansible (roles \& playbooks)} \\
\sectionsep
\runsubsectionlower{Artifacts:}\descript{Artifactory $\cdot$ ACR $\cdot$ Azure Artifacts}
&
% Second column - 7 items
\runsubsectionlower{Programming:}\descript{PHP $\cdot$ C# $\cdot$ Java} \\
\sectionsep
\runsubsectionlower{UI:}\descript{Joomla $\cdot$ WordPress $\cdot$ Angular $\cdot$ React $\cdot$ Asp.Net} \\
\sectionsep
\runsubsectionlower{Containers:}\descript{Docker $\cdot$ K8S} \\
\sectionsep
\runsubsectionlower{Templating:}\descript{Jinja2 $\cdot$ Nunjucks $\cdot$ FreeMarker} \\
\sectionsep
\runsubsectionlower{CSS:}\descript{sass $\cdot$ scss $\cdot$ less} \\
\sectionsep
\runsubsectionlower{Agile:}\descript{SAFe $\cdot$ Scrum $\cdot$ Kanban} \\
\sectionsep
\runsubsectionlower{Collaboration:}\descript{Jira $\cdot$ Confluence $\cdot$ Teams $\cdot$ Slack}
\end{tabular}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     Education
