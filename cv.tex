...
\begin{tabular}{ l l }
    % First column                                  % Second column
		\skillitem{Cloud:}{ Azure} & \skillitem{Artifacts:}{ Artifactory, Azure Artifacts, ACR} \\
		...
		\skillitem{CaC:}{ Ansible} & \skillitem{UI Frameworks:}{ WebComponents, Angular, React, Asp.NET Core} \\
		\skillitem{Scripting:}{ Bash, PowerShell, Python} & \skillitem{Templating engine:}{ Jinja2, Nunjucks} \\
		\skillitem{VCS:}{ GitHub, Azure Repos, Bitbucket} & \skillitem{Agile methodologies:}{ SAFe, Scrum, Kanban} \\
