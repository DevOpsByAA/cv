...
{\runsubsectionlower{Cloud:}\skilldescript{Microsoft Azure}} & {\runsubsectionlower{Programming:}\skilldescript{PHP $\cdot$ C\# $\cdot$ Java}} \\[12pt]
{\runsubsectionlower{IaC:}\skilldescript{Terraform $\cdot$ HCP}} & {\runsubsectionlower{UI:}\skilldescript{Joomla $\cdot$ WordPress $\cdot$ Angular $\cdot$ React $\cdot$ Asp.Net}} \\[12pt]
{\runsubsectionlower{CI/CD:}\skilldescript{Azure DevOps $\cdot$ GitHub Actions}} & {\runsubsectionlower{Containers:}\skilldescript{Docker $\cdot$ K8S}} \\[12pt]
{\runsubsectionlower{VCS:}\skilldescript{GitHub $\cdot$ Azure Repos $\cdot$ Bitbucket}} & {\runsubsectionlower{Templating:}\skilldescript{Jinja2 $\cdot$ Nunjucks $\cdot$ FreeMarker}} \\[12pt]
{\runsubsectionlower{Scripting:}\skilldescript{Bash $\cdot$ PowerShell $\cdot$ Python}} & {\runsubsectionlower{CSS:}\skilldescript{sass $\cdot$ scss $\cdot$ less}} \\[12pt]
{\runsubsectionlower{CaC:}\skilldescript{Ansible (roles \& playbooks)}} & {\runsubsectionlower{Agile:}\skilldescript{SAFe $\cdot$ Scrum $\cdot$ Kanban}} \\[12pt]
