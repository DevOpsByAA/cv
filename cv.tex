...
\begin{tightemize}
	...
	\item Expert in branching strategies, semantic versioning, and artifact management to maintain consistent, reliable, and traceable software releases.
\end{tightemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     Experience
...
\end{tightemize}
\sectionsep
\projets{Project(s):}{Cloud Transformation Program, Connectivity Landing Zone, Business Landing Zone}
\sectionsep
...
\end{tightemize}
\sectionsep
\projets{Project(s):}{Intellium, Strom, EspressoGo}
\sectionsep
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
\end{tightemize}
\sectionsep
\projets{Project(s):}{In-House Keycloak-based Single Sign-On solution}
\sectionsep
...
\end{tightemize}
\sectionsep
\projets{Project(s):}{Showcase \& Products Catalogs Websites}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     Education
%
...
\vspace{0.4cm}
\raggedright
\runsubsectionlower{Microsoft Certified}\descript{| GH-200 - GitHub Actions}\hfill \location{Certified since 2025}\\
\sectionsep
\runsubsectionlower{Microsoft Certified}\descript{| GH-900 - GitHub Fundamentals}\hfill \location{Certified since 2025}\\
\sectionsep
