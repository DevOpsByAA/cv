...
\begin{tabular}{ l l }
  % First column                                  % Second column
	\skillitem{Cloud:}{ Azure} & \skillitem{Programming:}{ C\# $\textbullet$ PHP} \\
	\skillitem{IaC:}{ Terraform $\textbullet$ Hashicorp Cloud Platform} & \skillitem{Containers:}{ Docker $\textbullet$ Kubernetes (AKS)} \\
	\skillitem{CI/CD:}{ Azure DevOps $\textbullet$ GitHub Actions} & \skillitem{UI Frameworks:}{ WebComponents $\textbullet$ Angular $\textbullet$ React $\textbullet$ Asp.NET} \\
	\skillitem{VCS:}{GitHub $\textbullet$ Azure Repos $\textbullet$ Bitbucket} & \skillitem{Templating engine:}{ Jinja2 $\textbullet$ Nunjucks} \\
	\skillitem{CaC:}{ Ansible (roles \& playbooks )} & \skillitem{CSS preprocessor:}{ sass, scss, less} \\
	\skillitem{Scripting:}{ Bash $\textbullet$ PowerShell $\textbullet$ Python} & \skillitem{Agile methodologies:}{ SAFe $\textbullet$ Scrum $\textbullet$ Kanban} \\
	\skillitem{Artifacts:}{ Artifactory $\textbullet$ Az Artifacts $\textbullet$ Az Container Registry} & \skillitem{Collaboration tools:}{ Jira $\textbullet$ Confluence $\textbullet$ Slack $\textbullet$ ProofHub $\textbullet$ MS Teams $\textbullet$ Zoom} \\
\end{tabular}
\sectionsep
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
