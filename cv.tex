...
\end{tightemize}
\sectionsep
\skills{Skills:}{ Azure Cloud, Terraform, Terraform Cloud Platform, Azure DevOps, GitHub Actions, Bash, PowerShell, Artifactory, Hashicorp Vaults, Az CLI, JFrog CLI, SAFe, Jira}
\sectionsep
